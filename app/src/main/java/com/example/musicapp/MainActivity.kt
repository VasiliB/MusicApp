...
//    private lateinit var lol: Response<List<Track>>
...
//        val deferred = scope.launch { getJsonResult() }

        val jsonResult = scopeIO.launch {
            getJsonResult()
...
//        tracksQuantity  = getTracksQuantity()
        ...
        binding.playBtn.setOnClickListener { // calling method to play audio.
            ...
            scopeMain.launch { playTrack(getJsonResult()) }
...
//            trackNotification()
    ...
    private suspend fun playTrack(json: Response<List<Track>>) = withContext(Dispatchers.IO) {
